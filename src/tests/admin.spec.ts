...
test.describe('Search Tests in Admin Listing page', () => {
    ...
    test.beforeEach(async ({ page }) => {
        ...
        await testHelpers.loginSuccessfully(page, 'Admin', 'admin123');
        await adminPage.navigateToAdminPage();
    });

    test('SE-01: Search for Username using valid keyword', async ({ page }) => {
    ...
    test('SE-02: Search for Employee Name using valid keyword', async ({ page }) => {
    ...
    test('SE-03: Search for no result Username', async ({ page }) => {
